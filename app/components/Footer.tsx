...
export default function Footer() {
  return (
    <footer className="relative bg-[#0a0a0a] border-t border-white/5">
      {/* Top accent line */}
      <div className="h-px bg-gradient-to-r from-transparent via-[#DD183B] to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-xs">
              Bold conversations. Real talk. A platform where every voice deserves a seat at the table.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-white/40 hover:text-[#DD183B] text-sm transition-colors duration-200"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <a
              href="mailto:contact@dafemedia.com"
              className="text-white/40 hover:text-[#DD183B] text-sm transition-colors duration-200 block mb-4"
            >
              contact@dafemedia.com
            </a>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/25 text-xs">
            &copy; {new Date().getFullYear()} SpadezTable &amp; DafeMedia. All rights reserved.
          </p>
          <p className="text-white/25 text-xs">
